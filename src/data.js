...
export const myExperience = [
    {
        company: "Aggregate Intelligence Pvt Ltd",
        role: "Research and Development Intern",
        duration: "Sep 2024 - Present",
        description: "Currently working on a project involving data analysis and machine learning using Python. and  PostgreSQL. Learning about data preprocessing, model training, and evaluation techniques. Working on projects using dotnet, c#, SQL, FAST API and React.js.",
    },
];
